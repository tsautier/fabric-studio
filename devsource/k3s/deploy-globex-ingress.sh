#!/bin/bash
#===============================================================================
# SCRIPT NAME:    deploy-globex-ingress.sh
# DESCRIPTION:    Deploy the globex app in namespace globex
...
export NAMESPACE=globex
export APPNAME=globex
export APPDESC="Globex Demo"
export DOCKER_IMAGE=sadubois/globex:latest
...
export DNS_DOMAIN_FORTIDEMO=apps-int.fortidemo.net
