#!/bin/bash
# ============================================================================================
# File: ........: edb_restapi_http_methods.sh
# Language .....: bash
# Author .......: Sacha Dubois, Fortinet
# --------------------------------------------------------------------------------------------
# Category .....: Application Protection
# Description ..: Test RestAPI HTTP Methods and Access
# ============================================================================================
...
echo ''
echo '   ____           _      _    ____ ___   _   _ _____ _____ ____    __  __      _   _               _         '
echo '  |  _ \ ___  ___| |_   / \  |  _ \_ _| | | | |_   _|_   _|  _ \  |  \/  | ___| |_| |__   ___   __| |___     '
echo '  | |_) / _ \/ __| __| / _ \ | |_) | |  | |_| | | |   | | | |_) | | |\/| |/ _ \ __|  _ \ / _ \ / _` / __|    '
echo '  |  _ <  __/\__ \ |_ / ___ \|  __/| |  |  _  | | |   | | |  __/  | |  | |  __/ |_| | | | (_) | (_| \__ \    '
echo '  |_| \_\___||___/\__/_/   \_\_|  |___| |_| |_| |_|   |_| |_|     |_|  |_|\___|\__|_| |_|\___/ \__,_|___/    '
echo ' ' 
...
id=$(curl -X GET "https://$SERVER/api/employees?sort_by=-id" \
             -H "Content-Type: application/json"   \
             -H "api_key: $EDB_APIKEY_ADMIN" 2>/dev/null | jq '.[-1].id' )

prtHead "Delete the entry with the ID=$id"
execCmd "curl -X DELETE \"https://$SERVER/api/employee/$id\" \\
             -H \"Content-Type: application/json\"   \\
             -H \"Accept: application/json\" \\
             2>/dev/null | sed 's/,}/}/' | jq -r"

prtHead "Delete the entry with the ID=$id with Admin API Key"
execCmd "curl -X DELETE \"https://$SERVER/api/employee/$id\" \\
             -H \"Content-Type: application/json\"   \\
             -H \"Accept: application/json\" \\
             -H \"api_key: $EDB_APIKEY_ADMIN\" \\
